      ...
      <div className="relative w-full max-w-lg max-h-[90vh] flex flex-col bg-white rounded-xl shadow-xl p-4 sm:p-6 overflow-hidden focus:outline-none">
        <div className="flex flex-row items-center gap-2 mb-2 shrink-0">
          ...
          <button
            ...
            className="shrink-0 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-gray-600 hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 cursor-pointer transition-colors"
          >
